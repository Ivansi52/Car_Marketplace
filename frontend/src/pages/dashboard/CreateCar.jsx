...
import { CREATE_CAR } from '../../services/queries'
      ...
      await createCar({
        variables: {
          input: {
            ...
            images: [], // Will be handled by REST API
          }
        }
      })
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Create New Car Listing</h1>
          <p className="mt-2 text-gray-600">Fill in the details to list your car for sale</p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-gray-500 mb-4">Maximum 10 images, 5MB each</p>
                <input
                  type="file"
                  multiple
                  accept="image/*"
